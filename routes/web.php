...
*/
/* FrontEnd Location */
Route::get('/json','ProductsController@getJSON');
Route::get('/iterator','ProductsController@iterate');
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    /// Orders Area
    Route::get('/orders','OrdersController@adminIndex');
    Route::get('/ordersPDF','OrdersController@generatePDF');
    /// Setting Area
