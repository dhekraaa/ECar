...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        $menu_active=3;
        $i=0;
        $tableDecorator = new TableDecorator();
        $products=$tableDecorator->show();
    ...
    public function iterate()
    {
        ...
        $productIterator = $productCollection->getIterator();
        return view ('iterator')->with('productCollection',$productCollection);
    }

    public function getJSON()
    {
        $JSONDecorator = new JSONDecorator();
        return $JSONDecorator->show();
    }
